...
void ATestUStructReplication::Server_StartTestImpl()
{
	...
	UStructWithStablyNamedObject.StablyNamedObject = LoadObject<UTestUObject>(nullptr, TEXT("/Script/GDKTestGyms.Default__TestUObject"));
	check(UStructWithStablyNamedObject.StablyNamedObject);

	// Setup UStruct with const stably named UObject
	UStructWithConstStablyNamedObject.StablyNamedObject = LoadObject<UTestUObject>(nullptr, TEXT("/Script/GDKTestGyms.Default__TestUObject"));
...
void ATestUStructReplication::Server_TearDownImpl()
{
	...
	{
		UE_LOG(LogSpatialGDKTestSuite, Log, TEXT("TestCase %s: Unable to tear down dynamically created actor"), *TestName);
	}
														 ...
														 const FCStyleEnumTestStruct& TestUStructWithCppStyleEnum)
{
	...
	check(TestUStructWithStablyNamedObject.StablyNamedObject->GetPathName() == TEXT("/Script/GDKTestGyms.Default__TestUObject"));
	...
	check(TestUStructWithConstStablyNamedObject.StablyNamedObject->GetPathName() == TEXT("/Script/GDKTestGyms.Default__TestUObject"));
