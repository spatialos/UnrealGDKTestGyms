...
void ATestUObjectReplication::Server_StartTestImpl()
{
	...
	StablyNamedUObject = LoadObject<UTestUObject>(nullptr, TEXT("/Script/GDKTestGyms.Default__TestUObject"));
	check(StablyNamedUObject);

	// Setup const UObject
	ConstObj = LoadObject<UTestUObject>(nullptr, TEXT("/Script/GDKTestGyms.Default__TestUObject"));
	check(ConstObj);
														 ...
														 const UTestUObject* TestConstObj)
{
	...
	check(TestStablyNamedUObject->GetPathName() == TEXT("/Script/GDKTestGyms.Default__TestUObject"));
	...
	check(TestConstObj->GetPathName() == TEXT("/Script/GDKTestGyms.Default__TestUObject"));
}
